...
tag='TagSet=[{Key=Owner,Value="Aakash"},{Key=Terraform,Value="true"},{Key="Purpose",Value="Prism-infra-POC"}]'
db_tag='[{"Key":"Owner","Value":"Aakash"},{"Key":"Terraform","Value":"true"},{"Key":"Purpose","Value":"prism-infra-POC"}]'
